...
static void p0(Info **infos,size_t ninfos,Token **tokens,size_t ntokens,Cite ***cites,size_t *ncites);

static void p1(Info **infos,size_t ninfos,Token **tokens,size_t ntokens,Cite ***cites,size_t *ncites);

static void p2(Info **infos,size_t ninfos,Token **tokens,size_t ntokens,Cite ***cites,size_t *ncites);

static void p3(Info **infos,size_t ninfos,Token **tokens,size_t ntokens,Cite ***cites,size_t *ncites);
